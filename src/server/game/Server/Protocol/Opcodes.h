...
enum Opcodes
{
    ...
    CMSG_NAME_QUERY                                   = 0x0018, // 17371
    CMSG_REALM_QUERY                                  = 0x0209, // 17371
    ...
    CMSG_CHANNEL_LIST                                 = 0x047B, // 17371
    ...
    CMSG_CONTACT_LIST                                 = 0x0000, // 17371
    CMSG_CORPSE_MAP_POSITION_QUERY                    = 0x6205,
    CMSG_CREATURE_QUERY                               = 0x050F, // 17371
    CMSG_DANCE_QUERY                                  = 0x4E07,
    CMSG_DB_QUERY_BULK                                = 0x0149, // 17371
    ...
    CMSG_DISMISS_CONTROLLED_VEHICLE                   = 0x0A56, // 17371
    ...
    CMSG_GAMEOBJECT_QUERY                             = 0x058F, // 17371
    ...
    CMSG_GOSSIP_HELLO                                 = 0x1414, // 17371
    CMSG_GOSSIP_SELECT_OPTION                         = 0x1341, // 17371
    ...
    CMSG_INSPECT                                      = 0x1515, // 17371
    CMSG_INSPECT_HONOR_STATS                          = 0x01D6, // 17371
    ...
    CMSG_LEARN_TALENT                                 = 0x2002, // 17371
    ...
    CMSG_LOAD_SCREEN                                  = 0x0341, // 17371
    CMSG_LOGOUT_CANCEL                                = 0x20E0,
    CMSG_LOGOUT_REQUEST                               = 0x1150, // 17371
    ...
    CMSG_MESSAGECHAT_RAID                             = 0x9997, // 17371
    CMSG_MESSAGECHAT_RAID_WARNING                     = 0x9998, 
    CMSG_MESSAGECHAT_SAY                              = 0x016A, // 17371
    CMSG_MESSAGECHAT_WHISPER                          = 0x143A, // 17371
    CMSG_MESSAGECHAT_YELL                             = 0x1333, // 17371
    ...
    CMSG_MOVE_FALL_RESET                              = 0x0AC3, // 17371
    ...
    CMSG_NPC_TEXT_QUERY                               = 0x009E, // 17371
    CMSG_OBJECT_UPDATE_FAILED                         = 0x0492, // 17371
    ...
    CMSG_RANDOMIZE_CHAR_NAME                          = 0x091D, // 17371
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x0755,
    CMSG_READ_ITEM                                    = 0x2F16,
    CMSG_REALM_SPLIT                                  = 0x0B48, // 17371
    CMSG_RECLAIM_CORPSE                               = 0x4036,
    CMSG_REDIRECTION_AUTH_PROOF                       = 0x1AA1, // 17371
    ...
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x0A82, // 17371
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x0400, // 17371
    CMSG_SET_ACTIVE_MOVER                             = 0x0A53, // 17371
    ...
    CMSG_SET_PLAYER_DECLINED_NAMES                    = 0x0815, // 17371
    ...
    CMSG_SET_SELECTION                                = 0x1759, // 17371
    ...
    CMSG_TEXT_EMOTE                                   = 0x1444, // 17371
    CMSG_TIME_ADJUSTMENT_RESPONSE                     = 0x215C,
    CMSG_TIME_SYNC_RESP                               = 0x0853, // 17371
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0856, // 17371
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0000,
    MSG_MOVE_START_ASCEND                             = 0x089F, // 17371
    MSG_MOVE_START_BACKWARD                           = 0x08D2, // 17371
    MSG_MOVE_START_DESCEND                            = 0x0893, // 17371
    MSG_MOVE_START_FORWARD                            = 0x0A4B, // 17371
    MSG_MOVE_START_PITCH_DOWN                         = 0x0A12, // 17371
    MSG_MOVE_START_PITCH_UP                           = 0x0C02, // 17371
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0816, // 17371
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0843, // 17371
    MSG_MOVE_START_SWIM                               = 0x0C13, // 17371
    MSG_MOVE_START_TURN_LEFT                          = 0x0A9E, // 17371
    MSG_MOVE_START_TURN_RIGHT                         = 0x0A07, // 17371
    MSG_MOVE_STOP                                     = 0x0813, // 17371
    MSG_MOVE_STOP_ASCEND                              = 0x0A47, // 17371
    MSG_MOVE_STOP_PITCH                               = 0x0AC7, // 17371
    MSG_MOVE_STOP_STRAFE                              = 0x0A4A, // 17371
    MSG_MOVE_STOP_SWIM                                = 0x0C93, // 17371
    MSG_MOVE_STOP_TURN                                = 0x080A, // 17371
    MSG_MOVE_TELEPORT                                 = 0x0C54, // 17371
    ...
    MSG_RAID_READY_CHECK                              = 0x0DDC, // 17371
    MSG_RAID_READY_CHECK_CONFIRM                      = 0x03C9, // 17371
    MSG_RAID_READY_CHECK_FINISHED                     = 0x1591, // 17371
    ...
    MSG_VERIFY_CONNECTIVITY                           = 0x4F57, // 17371
    SMSG_ACCOUNT_DATA_TIMES                           = 0x0CD1, // 17371
    SMSG_ACCOUNT_INFO_RESPONSE                        = 0x0FC9, // 17371
    SMSG_ACCOUNT_RESTRICTED_WARNING                   = 0x51A7,
    SMSG_ACHIEVEMENT_DELETED                          = 0x6A16,
    SMSG_ACHIEVEMENT_EARNED                           = 0x029D, // 17371
    SMSG_ACTION_BUTTONS                               = 0x019C, // 17371
    SMSG_ACTIVATETAXIREPLY                            = 0x6A37,
    SMSG_ADDON_INFO                                   = 0x0C80, // 17371
    SMSG_ADD_RUNE_POWER                               = 0x6915,
    SMSG_AI_REACTION                                  = 0x0637,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x12D1, // 17371
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x0734,
    SMSG_AREA_TRIGGER_MESSAGE                         = 0x4505,
    SMSG_AREA_TRIGGER_MOVEMENT_UPDATE                 = 0x0A91, // 17371
    SMSG_ARENA_ERROR                                  = 0x2D17,
    SMSG_ARENA_UNIT_DESTROYED                         = 0x2637,
    SMSG_ARENA_TEAM_CHANGE_FAILED_QUEUED              = 0x6E34,
    SMSG_ARENA_TEAM_COMMAND_RESULT                    = 0x06C1, // 17371
    SMSG_ARENA_TEAM_EVENT                             = 0x0617,
    SMSG_ARENA_TEAM_INVITE                            = 0x0F36,
    SMSG_ARENA_TEAM_QUERY_RESPONSE                    = 0x6336,
    SMSG_ARENA_TEAM_ROSTER                            = 0x14C0, // 17371
    SMSG_ARENA_TEAM_STATS                             = 0x4425,
    SMSG_ATTACKERSTATEUPDATE                          = 0x05A5, // 17371
    SMSG_ATTACKSTART                                  = 0x11D5, // 17371
    SMSG_ATTACKSTOP                                   = 0x0690, // 17371
    ...
    SMSG_AURA_UPDATE                                  = 0x036E, // 17371
    SMSG_AURA_UPDATE_ALL                              = 0x6916, // 17371
    SMSG_AUTH_CHALLENGE                               = 0x0221, // 17371
    SMSG_AUTH_RESPONSE                                = 0x0890, // 17371
    SMSG_AVAILABLE_VOICE_CHANNEL                      = 0x2E16,
    SMSG_AVERAGE_ITEM_LEVEL_INFORM                    = 0x04C5, // 17371
    SMSG_BARBER_SHOP_RESULT                           = 0x6125,
    SMSG_BATTLEFIELD_LIST                             = 0x0ACC, // 17371
    SMSG_BATTLEFIELD_MGR_EJECTED                      = 0x0091, // 17371
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING                = 0x0095, // 17371
    SMSG_BATTLEFIELD_MGR_ENTERED                      = 0x06D9, // 17371
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                 = 0x14D8, // 17371
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x05C5, // 17371
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                 = 0x0485, // 17371
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE       = 0x0D88, // 17371
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                 = 0x09C1, // 17371
    SMSG_BATTLEFIELD_PLAYER_POSITIONS                 = 0x03CC, // 17371
    SMSG_BATTLEFIELD_PORT_DENIED                      = 0x0F90, // 17371
    SMSG_BATTLEFIELD_RATED_INFO                       = 0x079D, // 17371
    SMSG_BATTLEFIELD_STATUS                           = 0x7DA1,
    SMSG_BATTLEFIELD_STATUS_QUEUED                    = 0x11D1, // 17371
    SMSG_BATTLEFIELD_STATUS_ACTIVE                    = 0x0CD8, // 17371
    SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION          = 0x09D5, // 17371
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS             = 0x0BDC, // 17371
    SMSG_BATTLEFIELD_STATUS_FAILED                    = 0x0798, // 17371
    SMSG_BATTLEGROUND_INFO_THROTTLED                  = 0x0D9D, // 17371
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x1281, // 17371
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x1581, // 17371
    // MOP Pet Battle
	/*
	...
	*/
    ...
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x078C, // 17371
    SMSG_CALENDAR_UPDATE_INVITE_LIST                  = 0x0000,
    SMSG_CAMERA_SHAKE                                 = 0x4214,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x6436,
    SMSG_CANCEL_COMBAT                                = 0x0281, // 17371
    SMSG_CAST_FAILED                                  = 0x1598, // 17371
    ...
    SMSG_CHANNEL_LIST                                 = 0x052C, // 17371
    SMSG_CHANNEL_MEMBER_COUNT                         = 0x6414,
    SMSG_CHANNEL_NOTIFY                               = 0x0825, // 17371
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x4417,
    SMSG_CHAR_CREATE                                  = 0x1495, // 17371
    SMSG_CHAR_CUSTOMIZE                               = 0x04E0,
    SMSG_CHAR_DELETE                                  = 0x14C1, // 17371
    SMSG_CHAR_ENUM                                    = 0x0FDD, // 17371
    SMSG_CHAR_FACTION_CHANGE                          = 0x4C06,
    SMSG_CHAR_RENAME                                  = 0x12C6,
    SMSG_CHAT_IGNORED_ACCOUNT_MUTED                   = 0x02C5, // 17371
    SMSG_CHAT_NOT_IN_PARTY                            = 0x6A14,
    SMSG_CHAT_PLAYER_AMBIGUOUS                        = 0x2F34,
    SMSG_CHAT_PLAYER_NOT_FOUND                        = 0x14D1, // 17371
    SMSG_CHAT_RESTRICTED                              = 0x099C, // 17371
    SMSG_CHAT_SERVER_DISCONNECTED                     = 0x1294, // 17371
    SMSG_CHAT_SERVER_RECONNECTED                      = 0x04DD, // 17371
    SMSG_CHAT_WRONG_FACTION                           = 0x6724,
    SMSG_CHECK_FOR_BOTS                               = 0x0000,
    SMSG_CLEAR_BOSS_EMOTES                            = 0x1395, // 17371
    SMSG_CLEAR_COOLDOWN                               = 0x0627,
    SMSG_CLEAR_COOLDOWNS                              = 0x59B4,
    SMSG_CLEAR_FAR_SIGHT_IMMEDIATE                    = 0x2A04,
    SMSG_CLEAR_TARGET                                 = 0x4B26,
    SMSG_CLIENTCACHE_VERSION                          = 0x1489, // 17371
    ...
    SMSG_CONTACT_LIST                                 = 0x1924, // 17371
    ...
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x13C9, // 17371
    SMSG_CREATURE_QUERY_RESPONSE                      = 0x06D8, // 17371
    SMSG_CRITERIA_DELETED                             = 0x039C, // 17371
    SMSG_CRITERIA_UPDATE                              = 0x05D4, // 17371
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x2036,
    SMSG_CURRENCY_LOOT_REMOVED                        = 0x1DB4,
    SMSG_CURRENCY_LOOT_RESTORED                       = 0x30A0,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x03DC, // 17371
    SMSG_DAMAGE_CALC_LOG                              = 0x2436,
    SMSG_DAMAGE_DONE_OBSOLETE                         = 0x0000,
    SMSG_DANCE_QUERY_RESPONSE                         = 0x2F06,
    SMSG_DB_REPLY                                     = 0x00DC, // 17371
    SMSG_DEATH_RELEASE_LOC                            = 0x2F07,
    SMSG_DEBUG_RUNE_REGEN                             = 0x0C9C, // 17371
    SMSG_DEFENSE_MESSAGE                              = 0x0314,
    SMSG_DESTROY_OBJECT                               = 0x04D1, // 17371
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x4825,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x0DD5, // 17371
    SMSG_DISENCHANT_CREDIT                            = 0x12C9, // 17371
    SMSG_DISMOUNT                                     = 0x2135,
    SMSG_DISMOUNTRESULT                               = 0x0CC5, // 17371
    SMSG_DISPEL_FAILED                                = 0x0307,
    SMSG_DISPLAY_GAME_ERROR                           = 0x07D5, // 17371
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR          = 0x0BD9, // 17371
    ...
    SMSG_DUMP_RIDE_TICKETS_RESPONSE                   = 0x10D5, // 17371
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x4C27,
    SMSG_ECHO_PARTY_SQUELCH                           = 0x0814,
    SMSG_EMOTE                                        = 0x9994, // 17371
    SMSG_ENABLE_BARBER_SHOP                           = 0x2D16,
    SMSG_ENCHANTMENTLOG                               = 0x6035,
    SMSG_ENVIRONMENTALDAMAGELOG                       = 0x6C05,
    SMSG_EQUIPMENT_SET_LIST                           = 0x2E04,
    SMSG_EQUIPMENT_SET_SAVED                          = 0x0888, // 17371
    SMSG_EQUIPMENT_SET_USE_RESULT                     = 0x12CD, // 17371
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x4D36,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x0D84, // 17371
    SMSG_FAILED_PLAYER_CONDITION                      = 0x02CD, // 17371
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x15D1, // 17371
    ...
    SMSG_GODMODE                                      = 0x0405, // 17371
    SMSG_GOSSIP_COMPLETE                              = 0x0806,
    SMSG_GOSSIP_MESSAGE                               = 0x13AD, // 17371
    SMSG_GOSSIP_POI                                   = 0x15A7, // 17371
    SMSG_GROUPACTION_THROTTLED                        = 0x1394, // 17371
    SMSG_GROUP_CANCEL                                 = 0x4D25,
    SMSG_GROUP_DECLINE                                = 0x6835,
    SMSG_GROUP_DESTROYED                              = 0x2207,
    SMSG_GROUP_INVITE                                 = 0x11DD, // 17371
    ...
    SMSG_GUILD_REPUTATION_WEEKLY_CAP                  = 0x1A83, // 17371
    SMSG_GUILD_RESET                                  = 0x1CB5,
    SMSG_GUILD_REWARDS_LIST                           = 0x1DB0,
    SMSG_GUILD_ROSTER                                 = 0x0C0A, // 17371
    ...
    SMSG_HEALTH_UPDATE                                = 0x13D8, // 17371
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x4104,
    SMSG_HOTFIX_INFO                                  = 0x1584, // 17371 - @TODO: Check if this is CORRECT
    SMSG_HOTFIX_NOTIFY                                = 0x0EDC, // 17371
    SMSG_INITIALIZE_FACTIONS                          = 0x0598, // 17371
    SMSG_INITIAL_SPELLS                               = 0x173F, // 17371
    SMSG_INIT_CURRENCY                                = 0x1595, // 17371
    SMSG_INIT_WORLD_STATES                            = 0x0FDC, // 17371
    SMSG_INSPECT                                      = 0x0000,
    SMSG_INSPECT_HONOR_STATS                          = 0x109C, // 17371
    SMSG_INSPECT_RATED_BG_STATS                       = 0x1498, // 17371
    SMSG_INSPECT_RESULTS_UPDATE                       = 0x0B98, // 17371
    ...
    SMSG_INVALIDATE_PLAYER                            = 0x0ED5, // 17371
    SMSG_INVALID_PROMOTION_CODE                       = 0x6F25,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x2236,
    SMSG_ITEM_ADD_PASSIVE                             = 0x1384, // 17371
    SMSG_ITEM_COOLDOWN                                = 0x4D14,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x0799, // 17371
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x0F81, // 17371
    SMSG_ITEM_PUSH_RESULT                             = 0x129D, // 17371
    SMSG_ITEM_REFUND_INFO_RESPONSE                    = 0x15A3,
    SMSG_ITEM_REFUND_RESULT                           = 0x06C5, // 17371
    SMSG_ITEM_REMOVE_PASSIVE                          = 0x1298, // 17371
    SMSG_ITEM_SEND_PASSIVE                            = 0x0DDD, // 17371
    SMSG_ITEM_TEXT_QUERY_RESPONSE                     = 0x2725,
    SMSG_ITEM_TIME_UPDATE                             = 0x0CC0, // 17371
    SMSG_JOINED_BATTLEGROUND_QUEUE                    = 0x0000,
    SMSG_KICK_REASON                                  = 0x0000,
    SMSG_LEARNED_DANCE_MOVES                          = 0x0E05,
    SMSG_LEARNED_SPELL                                = 0x058C, // 17371
    SMSG_LEVELUP_INFO                                 = 0x00CD, // 17371
    SMSG_LFG_BOOT_PROPOSAL_UPDATE                     = 0x0F05,
    SMSG_LFG_DISABLED                                 = 0x0895, // 17371
    SMSG_LFG_JOIN_RESULT                              = 0x0291, // 17371
    SMSG_LFG_OFFER_CONTINUE                           = 0x12C4, // 17371
    SMSG_LFG_OPEN_FROM_GOSSIP                         = 0x0000,
    SMSG_LFG_PARTY_INFO                               = 0x048D, // 17371
    SMSG_LFG_PLAYER_INFO                              = 0x07D9, // 17371
    SMSG_LFG_PLAYER_REWARD                            = 0x0E90, // 17371
    SMSG_LFG_PROPOSAL_UPDATE                          = 0x12C8, // 17371
    SMSG_LFG_QUEUE_STATUS                             = 0x0498, // 17371
    SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x08D1, // 17371
    SMSG_LFG_ROLE_CHOSEN                              = 0x6A26,
    SMSG_LFG_SLOT_INVALID                             = 0x119D, // 17371
    SMSG_LFG_TELEPORT_DENIED                          = 0x049D, // 17371
    SMSG_LFG_UPDATE_LIST                              = 0x0000,
    SMSG_LFG_UPDATE_SEARCH                            = 0x54A1,
    SMSG_LFG_UPDATE_STATUS                            = 0x0E98, // 17371
    SMSG_LFG_UPDATE_STATUS_NONE                       = 0x0A89, // 17371
    ...
    SMSG_LOAD_CUF_PROFILES                            = 0x09CC, // 17371
    SMSG_LOGIN_SETTIMESPEED                           = 0x0C8D, // 17371
    SMSG_LOGIN_VERIFY_WORLD                           = 0x0434, // 17371
    SMSG_LOGOUT_CANCEL_ACK                            = 0x05D5, // 17371
    SMSG_LOGOUT_COMPLETE                              = 0x15C9, // 17371
    SMSG_LOGOUT_RESPONSE                              = 0x14D5, // 17371
    SMSG_LOG_XPGAIN                                   = 0x09CD, // 17371
    SMSG_LOOT_ALL_PASSED                              = 0x0DC1, // 17371
    SMSG_LOOT_CLEAR_MONEY                             = 0x2B37,
    SMSG_LOOT_CONTENTS                                = 0x0580, // 17371
    SMSG_LOOT_ITEM_NOTIFY                             = 0x6D15,
    SMSG_LOOT_LIST                                    = 0x1199, // 17371
    SMSG_LOOT_MASTER_LIST                             = 0x0994, // 17371
    SMSG_LOOT_MONEY_NOTIFY                            = 0x0180, // 17371
    SMSG_LOOT_RELEASE_RESPONSE                        = 0x12C1, // 17371
    SMSG_LOOT_REMOVED                                 = 0x0E8C, // 17371
    SMSG_LOOT_RESPONSE                                = 0x08CD, // 17371
    SMSG_LOOT_ROLL                                    = 0x158C, // 17371
    SMSG_LOOT_ROLL_WON                                = 0x0985, // 17371
    SMSG_LOOT_SLOT_CHANGED                            = 0x2935,
    SMSG_LOOT_START_ROLL                              = 0x10C8, // 17371
    SMSG_MAIL_LIST_RESULT                             = 0x4217,
    SMSG_MAP_OBJ_EVENTS                               = 0x0A84, // 17371
    ...
    SMSG_MESSAGECHAT                                  = 0x0699, // 17371
    SMSG_MESSAGE_BOX                                  = 0x14D9, // 17371
    SMSG_MINIGAME_SETUP                               = 0x6727,
    SMSG_MINIGAME_STATE                               = 0x2E17,
    SMSG_MIRRORIMAGE_DATA                             = 0x2634,
    SMSG_MISSILE_CANCEL                               = 0x03CD, // 17371
    SMSG_MODIFY_COOLDOWN                              = 0x6016,
    SMSG_MONEY_NOTIFY                                 = 0x0DCC, // 17371
    SMSG_MONSTER_MOVE                                 = 0x114C, // 17371
    SMSG_MONSTER_MOVE_TRANSPORT                       = 0x2004,
    SMSG_MOTD                                         = 0x12DC, // 17371
    SMSG_MOUNTRESULT                                  = 0x15D0, // 17371
    ...
    SMSG_MOVE_SET_CAN_FLY                             = 0x0F48, // 17371
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x0BD0, // 17371
    SMSG_NEW_TAXI_PATH                                = 0x4B35,
    SMSG_NEW_WORLD                                    = 0x04D9, // 17371
    SMSG_NEW_WORLD_ABORT                              = 0x0399, // 17371
    ...
    SMSG_PAGE_TEXT_QUERY_RESPONSE                     = 0x0384, // 17371
    ...
    SMSG_PETITION_ALREADY_SIGNED                      = 0x10CD, // 17371
    ...
    SMSG_PET_ACTION_FEEDBACK                          = 0x08C4, // 17371
    SMSG_PET_ACTION_SOUND                             = 0x13D1, // 17371
    SMSG_PET_ADDED                                    = 0x0DD4, // 17371
    SMSG_PET_BROKEN                                   = 0x2E27,
    SMSG_PET_CAST_FAILED                              = 0x01D9, // 17371
    SMSG_PET_DISMISS_SOUND                            = 0x0ED1, // 17371
    SMSG_PET_GUIDS                                    = 0x15CD, // 17371
    SMSG_PET_LEARNED_SPELL                            = 0x1594, // 17371
    SMSG_PET_MODE                                     = 0x0085, // 17371
    SMSG_PET_NAME_INVALID                             = 0x0380, // 17371
    SMSG_PET_NAME_QUERY_RESPONSE                      = 0x0198, // 17371
    SMSG_PET_REMOVED_SPELL                            = 0x0F9D, // 17371
    SMSG_PET_RENAMEABLE                               = 0x2B27,
    SMSG_PET_SLOT_UPDATED                             = 0x03C0, // 17371
    SMSG_PET_SPELLS                                   = 0x4114,
    SMSG_PET_TAME_FAILURE                             = 0x0689, // 17371
    SMSG_PET_UPDATE_COMBO_POINTS                      = 0x4325,
    SMSG_PLAYED_TIME                                  = 0x0995, // 17371
    SMSG_PLAYERBINDERROR                              = 0x6A24,
    SMSG_PLAYERBOUND                                  = 0x12DD, // 17371
    SMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x2217,
    SMSG_PLAYER_MOVE                                  = 0x1109, // 17371
    ...
    SMSG_PLAY_SPELL_VISUAL                            = 0x07D0, // 17371
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x01C1, // 17371
    SMSG_PLAY_TIME_WARNING                            = 0x4814,
    SMSG_PONG                                         = 0x1121, // 17371
    SMSG_POWER_UPDATE                                 = 0x0DC5, // 17371
    ...
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                 = 0x0DD1, // 17371
    SMSG_RESURRECT_REQUEST                            = 0x0FD0, // 17371
    SMSG_RESYNC_RUNES                                 = 0x6224,
    SMSG_ROLE_POLL_BEGIN                              = 0x0CDC, // 17371
    SMSG_RWHOIS                                       = 0x2437,
    SMSG_SELL_ITEM                                    = 0x6105,
	SMSG_SCENARIO_STATE                               = 0x009C, // 17371
	SMSG_SCENARIO_POIS                                = 0x0C88, // 17371
	SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x0295, // 17371
    SMSG_SEND_MAIL_RESULT                             = 0x4927,
    SMSG_SEND_UNLEARN_SPELLS                          = 0x4E25,
    SMSG_SERVERTIME                                   = 0x0789, // 17371
    SMSG_SERVER_FIRST_ACHIEVEMENT                     = 0x6424,
    SMSG_SERVER_INFO_RESPONSE                         = 0x0ED4, // 17371
    SMSG_SERVER_MESSAGE                               = 0x6C04,
    SMSG_SERVER_PERF                                  = 0x74B6,
    SMSG_SET_AI_ANIM_KIT                              = 0x0000,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x01C0, // 17371
    ...
    SMSG_SET_FORCED_REACTIONS                         = 0x069D, // 17371
    SMSG_SET_MELEE_ANIM_KIT                           = 0x0000,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x0000,
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x0224,
    SMSG_SET_PHASE_SHIFT                              = 0x0BD4, // 17371
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x08CC, // 17371
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x0A80, // 17371
    SMSG_SET_PROFICIENCY                              = 0x00C1, // 17371
    SMSG_SET_PROJECTILE_POSITION                      = 0x2616,
    SMSG_SHOWTAXINODES                                = 0x2A36,
    SMSG_SHOW_BANK                                    = 0x01C4, // 17371
    SMSG_SHOW_RATINGS                                 = 0x0A85, // 17371
    SMSG_SOCKET_GEMS_RESULT                           = 0x6014,
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x11DC, // 17371
    ...
    SMSG_SPELL_FAILURE                                = 0x108C, // 17371
    SMSG_SPELL_GO                                     = 0x0765, // 17371
    SMSG_SPELL_START                                  = 0x1675, // 17371
    ...
    SMSG_STABLE_RESULT                                = 0x118D, // 17371
    SMSG_STANDSTATE_UPDATE                            = 0x6F04,
    SMSG_START_MIRROR_TIMER                           = 0x6824,
    SMSG_START_TIMER                                  = 0x0988, // 17371
    SMSG_STOP_DANCE                                   = 0x4637,
    SMSG_STOP_MIRROR_TIMER                            = 0x0B06,
    SMSG_STREAMING_MOVIE                              = 0x0989, // 17371
    SMSG_SUMMON_CANCEL                                = 0x0B34,
    SMSG_SUMMON_REQUEST                               = 0x079C, // 17371
    SMSG_SUPERCEDED_SPELL                             = 0x0F99, // 17371
    SMSG_SUPPRESS_NPC_GREETINGS                       = 0x0F85, // 17371
    SMSG_SUSPEND_COMMS                                = 0x4140,
    SMSG_SUSPEND_TOKEN_RESPONSE                       = 0x03DD, // 17371
    ...
    SMSG_TEXT_EMOTE                                   = 0x1185, // 17371
    SMSG_THREAT_CLEAR                                 = 0x0199, // 17371
    SMSG_THREAT_REMOVE                                = 0x0EC0, // 17371
    SMSG_THREAT_UPDATE                                = 0x1080, // 17371
    SMSG_TIME_ADJUSTMENT                              = 0x159C, // 17371
    SMSG_TIME_SYNC_REQ                                = 0x0AD4, // 17371
    SMSG_TITLE_EARNED                                 = 0x02D0, // 17371
    SMSG_TOGGLE_XP_GAIN                               = 0x6704,
    SMSG_TOTEM_CREATED                                = 0x2414,
    SMSG_TRADE_STATUS                                 = 0x0DC0, // 17371
    SMSG_TRADE_STATUS_EXTENDED                        = 0x70A2,
    SMSG_TRAINER_BUY_FAILED                           = 0x08C5, // 17371
    SMSG_TRAINER_BUY_SUCCEEDED                        = 0x6A05,
    SMSG_TRAINER_LIST                                 = 0x08C9, // 17371
    SMSG_TRANSFER_ABORTED                             = 0x0537,
    SMSG_TRANSFER_PENDING                             = 0x13CD, // 17371
    SMSG_TRIGGER_CINEMATIC                            = 0x15BE, // 17371
    SMSG_TRIGGER_MOVIE                                = 0x1198, // 17371
    SMSG_TURN_IN_PETITION_RESULTS                     = 0x0F07,
    SMSG_TUTORIAL_FLAGS                               = 0x0D7E, // 17371
    SMSG_UNIT_HEALTH_FREQUENT                         = 0x2C26,
    SMSG_UNIT_SPELLCAST_START                         = 0x2517,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x0684, // 17371
    SMSG_UPDATE_ACCOUNT_DATA_COMPLETE                 = 0x0000,
    SMSG_UPDATE_COMBO_POINTS                          = 0x6B34,
    SMSG_UPDATE_CURRENCY                              = 0x0000, // 17371
    SMSG_UPDATE_CURRENCY_WEEK_LIMIT                   = 0x70A7,
    SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x03D9, // 17371
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT               = 0x4007,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x4915,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x0437,
    SMSG_UPDATE_OBJECT                                = 0x0C65, // 17371
    SMSG_UPDATE_SERVER_PLAYER_POSITION                = 0x0E84, // 17371
    SMSG_UPDATE_WORLD_STATE                           = 0x13C8, // 17371
    SMSG_USERLIST_ADD                                 = 0x13C5, // 17371
    SMSG_USERLIST_REMOVE                              = 0x0899, // 17371
    SMSG_USERLIST_UPDATE                              = 0x0AC5, // 17371
    SMSG_VOICESESSION_FULL                            = 0x6225,
    SMSG_VOICE_CHAT_STATUS                            = 0x07DC, // 17371
    SMSG_VOICE_PARENTAL_CONTROLS                      = 0x0CC9, // 17371
    SMSG_VOICE_SESSION_LEAVE                          = 0x08D0, // 17371
    SMSG_VOICE_SESSION_ROSTER_UPDATE                  = 0x1291, // 17371
    SMSG_VOICE_SET_TALKER_MUTED                       = 0x6E35,
    SMSG_VOID_ITEM_SWAP_RESPONSE                      = 0x78A2,
    SMSG_VOID_STORAGE_CONTENTS                        = 0x0F9C, // 17371
    SMSG_VOID_STORAGE_FAILED                          = 0x078D, // 17371
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x06C9, // 17371
    SMSG_VOID_TRANSFER_RESULT                         = 0x05C9, // 17371 
    SMSG_WAIT_QUEUE_FINISH                            = 0x06C8, // 17371
    SMSG_WAIT_QUEUE_UPDATE                            = 0x05D1, // 17371
    SMSG_WARDEN_DATA                                  = 0x12D9, // 17371
    SMSG_WARGAME_CHECK_ENTRY                          = 0x3DA4,
    SMSG_WARGAME_REQUEST_SENT                         = 0x0E85, // 17371
    SMSG_WEATHER                                      = 0x1391, // 17371
    SMSG_WEEKLY_LAST_RESET                            = 0x01D4, // 17371
    SMSG_WEEKLY_RESET_CURRENCY                        = 0x3CA1,
    SMSG_WEEKLY_SPELL_USAGE                           = 0x39B7,
    SMSG_WEEKLY_SPELL_USAGE_UPDATE                    = 0x11B5,
    SMSG_WHO                                          = 0x11C0, // 17371
    SMSG_WHOIS                                        = 0x0D89, // 17371
    SMSG_WORLD_SERVER_INFO                            = 0x1091, // 17371
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                  = 0x4A14,
    SMSG_XP_GAIN_ABORTED                              = 0x1188, // 17371
    SMSG_ZONE_UNDER_ATTACK                            = 0x053F, // 17371
};
